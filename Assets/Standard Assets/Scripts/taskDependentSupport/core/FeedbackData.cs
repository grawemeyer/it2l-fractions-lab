...

{
	...
	public class FeedbackData
	{
		...
		public FeedbackElem getFeedbackElem(string id){
			...
			else if (M12.getID ().Equals (id)) return M12;
			else if (M13.getID ().Equals (id)) return M13;
			...
			else if (FM12.getID ().Equals (id)) return FM12;
			...
			else if (T24M12.getID ().Equals (id)) return T24M12;
			else if (T24M13.getID ().Equals (id)) return T24M13;
